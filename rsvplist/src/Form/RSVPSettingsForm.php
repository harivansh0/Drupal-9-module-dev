...
public function buildForm(array $form, FormStateInterface $form_state, Request $request = NULL ){
    ...
    $form['rsvplist_types'] = array(
        '#type' => 'checkboxes',
        '#title' => $this->t('The contents types to enabled RSVP collection for'),
        '#default_value' => $config->get('allowed_types'),
        '#options' => $types,
        '#description' => t('On the specified node types, an RSVP options will be available 
        and can be enabled while tha node is being edited.'),
    );
